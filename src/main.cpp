...
SETUP:
(1) Change the placeholder values in 'secrets.h' to your values
(2) Upload the code to your ESP32 board
(3) You can see your ESPs IP on Serial Monitor (9600 Baud Rate) and on the OLED.
    You need to add the IP address of your ESP to REDIRECT_URI definition in 'secrets.h': https://YOUR_ESP_IP/callback
(4) Remember to add this REDIRECT_URI to your Spotify Developer Dashboard app settings as well.
(5) !REMEMBER TO CHANGE THE VALUES in esp32_https_library (details in repo readme)
*/
